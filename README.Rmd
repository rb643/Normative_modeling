...
* runs the a one-sample test on the w-scores with outliers removed
...
The above functions are all dependent on each other and should thus be run in succession. However, with other parcellations or metrics each step should also be doable using the mcparallel function