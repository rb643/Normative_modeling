...
```{r, include=FALSE}
varianceStats(measure = "LGI", parcellation = "500aparc")
varianceStats(measure = "CT", parcellation = "500aparc")
varianceStats(measure = "Area", parcellation = "500aparc")
varianceStats(measure = "Vol", parcellation = "500aparc")
```
...
Like this:
![image](./Plots/Overview2.png)
```{r, include=FALSE}
Job1 = mcparallel(localRegression(measure = "LGI", parcellation = "500aparc"))
Job2 = mcparallel(localRegression(measure = "CT", parcellation = "500aparc"))
Job3 = mcparallel(localRegression(measure = "Area", parcellation = "500aparc"))
Job4 = mcparallel(localRegression(measure = "Vol", parcellation = "500aparc"))
mccollect(list(Job1, Job2, Job3, Job4))
```
...
```{r, include=FALSE}
Job1 = mcparallel(basicStats(measure = "LGI", parcellation = "500aparc"))
Job2 = mcparallel(basicStats(measure = "CT", parcellation = "500aparc"))
Job3 = mcparallel(basicStats(measure = "Area", parcellation = "500aparc"))
Job4 = mcparallel(basicStats(measure = "Vol", parcellation = "500aparc"))
mccollect(list(Job1, Job2, Job3, Job4))
```
...
```{r, include=FALSE}
Job1 = mcparallel(symptomCorrelation(measure = "LGI", parcellation = "500aparc"))
Job2 = mcparallel(symptomCorrelation(measure = "CT", parcellation = "500aparc"))
Job3 = mcparallel(symptomCorrelation(measure = "Area", parcellation = "500aparc"))
Job4 = mcparallel(symptomCorrelation(measure = "Vol", parcellation = "500aparc"))
mccollect(list(Job1, Job2, Job3, Job4))
```

# Optional other functions
The above functions are all dependent on each other and should thus be run in succession. However, with other parcellations or metrics each step is split across cores using the mcparallel function
